      ...
      <section className="rounded-3xl border border-red-100 bg-white p-5 shadow-[0_15px_45px_rgba(220,38,38,0.08)] sm:p-7">
        ...
        <div className="mt-5 grid grid-cols-1 gap-3 sm:grid-cols-3">
          <div className="rounded-2xl border border-red-100 bg-gradient-to-b from-[#f8f8fa] to-white px-4 py-4">
            ...
            <b className="mt-1 block text-2xl text-red-600">
              {formatNumber(totals._count)}건
            </b>
          </div>
          <div className="rounded-2xl border border-red-100 bg-gradient-to-b from-[#f8f8fa] to-white px-4 py-4">
        ...
        <h2 className="mt-8 text-lg font-semibold sm:text-xl">
          🚘 차량별 현황
        </h2>
          ...
          <table className="w-full min-w-[900px] border-separate border-spacing-0 text-sm sm:text-base">
            <thead>
              <tr className="bg-[#f7f7f9] text-gray-700">
                <th className="sticky left-0 z-10 border-b border-red-100 bg-[#f7f7f9] p-3 text-left">
                  차량
                </th>
                <th className="border-b border-red-100 p-3 text-right">
                  월 건수
                </th>
                <th className="border-b border-red-100 p-3 text-right">
                  월 주행(km)
            ...
            <tbody>
              {byVehicle.map(({ v, agg, latest }, idx) => (
                <tr
                  key={v.id}
                  className={idx % 2 ? "bg-[#fcfcfd]" : "bg-white"}
                >
                  ...
                  <td className="border-b border-red-50 p-3 text-right whitespace-nowrap">
          ...
          <table className="w-full min-w-[980px] border-separate border-spacing-0 text-sm sm:text-base">
            <thead>
              <tr className="bg-[#f7f7f9] text-gray-700">
                ...
                <th className="border-b border-red-100 p-3 text-left">
                  운전자
                </th>
                <th className="border-b border-red-100 p-3 text-right">
                  주행(km)
            ...
            <tbody>
              {recentTrips.map((t, idx) => (
                ...
                >
                  ...
                  <td className="max-w-[280px] border-b border-red-50 p-3">
                    {t.note ?? ""}
                  </td>
                </tr>
              ))}
        ...
        <p className="mt-6">
          <Link
            className="inline-flex rounded-xl border border-red-200 px-3 py-2 hover:text-red-600"
            href="/"
          >
            ⬅️ 입력으로
          </Link>
