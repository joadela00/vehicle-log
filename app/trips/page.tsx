                    ...
                    <div className="grid grid-cols-[64px_1fr] items-start gap-2">
                      ...
                      <dd className="flex items-center justify-between gap-3">
                        ...
                        <span className="flex items-center gap-2">
                          <Link
                            href={`/trips/${t.id}`}
                            className="inline-flex items-center rounded-lg border border-red-200 px-2 py-1 text-red-700 hover:text-red-800"
                            aria-label="운행일지 수정"
                          >
                            ✏︎
                          </Link>
              ...
              <table className="w-full border-collapse">
                <thead>
                  <tr className="border-b">
                    ...
                    <th className="p-2 text-right">✏︎ 수정</th>
                    <th className="p-2 text-right">🗑︎ 삭제</th>
                  </tr>
                </thead>
                  ...
                  {trips.map((t) => (
                    <tr key={t.id} className="border-b">
                      ...
                      <td className="p-2 text-right">
                        <Link
                          href={`/trips/${t.id}`}
                          className="inline-flex items-center rounded-lg border border-red-200 px-2 py-1 text-red-900 hover:text-red-700"
                          aria-label="운행일지 수정"
                        >
                          ✏︎
                        </Link>
