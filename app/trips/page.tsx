                ...
                >
                  <div className="flex items-start justify-between gap-4">
                    ...
                    <div className="grid gap-1 min-w-0">
                      ...
                      <div
                        className="block w-full max-w-full box-border min-w-0 rounded-xl border bg-white px-3 py-2 text-sm shadow-sm"
                        aria-label="날짜"
                      >
                  ...
                  <dl className="mt-4 space-y-2 text-sm">
                    ...
                    <div className="grid grid-cols-[64px_1fr] items-start gap-2">
                      <dt className="whitespace-nowrap text-gray-500">
                        주행거리
                      </dt>
